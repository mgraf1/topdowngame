...
public class PlayerControllerTests {
	...
	public void handleInputNoInput() {
		...
		playerController.handleInput(false, false, false, false);
	...
	public void handleInputUp() {
		...
		playerController.handleInput(true, false, false, false);
	...
	public void handleInputDown() {
		...
		playerController.handleInput(false, true, false, false);
	...
	public void handleInputLeft() {
		...
		playerController.handleInput(false, false, true, false);
	...
	public void handleInputRight() {
		...
		playerController.handleInput(false, false, false, true);
	...
	public void handleInputMultipleContinueUp() {
		...
		playerController.handleInput(true, false, false, false);
		playerController.handleInput(true, true, true, true);
